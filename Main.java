...
// Stores a list of items (food) into different ArrayLists as wishlist, cart, and orders
class User {
    String username;
    String password;
    ...
    // Displays the menu for food items and provies options to add items, view the cart, wishlist, and orders
    void buyFood() {
        ...
        do {
            ...
            switch (choice) {
                ...
                case 1:
                    ...
                    if (ch == 1) {
                        totalItems++;
                        ob = new Item(totalItems, "Item 1", qty, 100 * qty);
                        cart.cartItems.add(ob);
                        
                        try {
                            Main.stmt.executeUpdate("INSERT INTO " + username + "_CART" + " VALUES (" + totalItems + " , 'ITEM 1', " + qty + ", " + (100 * qty) + ");");
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        
                        cart.totalPrice += 100 * qty;
                    }
                    // Add to wishlist
                    else {
                        totalItems++;
                        ...
                        try {
                            Main.stmt.executeUpdate("INSERT INTO " + username + "_WISHLIST" + " VALUES (" + totalItems + " , 'ITEM 1', " + qty + ", " + (100 * qty) + ");");
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
                ...
                case 2:
                    ...
                    if (ch == 1) {
                        totalItems++;
                        ob = new Item(totalItems, "Item 2", qty, 150 * qty);
                        cart.cartItems.add(ob);
                        
                        try {
                            Main.stmt.executeUpdate("INSERT INTO " + username + "_CART" + " VALUES (" + totalItems + " , 'ITEM 2', " + qty + ", " + (150 * qty) + ");");
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        
                        cart.totalPrice += 150 * qty;
                    }
                    // Add to wishlist
                    else {
                        totalItems++;
                        ...
                        try {
                            Main.stmt.executeUpdate("INSERT INTO " + username + "_WISHLIST" + " VALUES (" + totalItems + " , 'ITEM 2', " + qty + ", " + (150 * qty) + ");");
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
                ...
                case 3:
                    ...
                    if (ch == 1) {
                        totalItems++;
                        ob = new Item(totalItems, "Item 3", qty, 175 * qty);
                        cart.cartItems.add(ob);
                ...
                case 4:
                    ...
                    if (ch == 1) {
                        totalItems++;
                        ob = new Item(totalItems, "Item 4", qty, 225 * qty);
                        cart.cartItems.add(ob);
                        
                        try {
                            Main.stmt.executeUpdate("INSERT INTO " + username + "_CART" + " VALUES (" + totalItems + " , 'ITEM 4', " + qty + ", " + (225 * qty) + ");");
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        
                        cart.totalPrice += 225 * qty;
                    }
                    // Add to wishlist
                    else {
                        totalItems++;
                        ...
                        try {
                            Main.stmt.executeUpdate("INSERT INTO " + username + "_WISHLIST" + " VALUES (" + totalItems + " , 'ITEM 4', " + qty + ", " + (225 * qty) + ");");
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
    ...
    // Displays the main menu to buy food, view the wishlist, cart, or orders
    void mainMenu() {
        int choice;
...
public class Main {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost/?characterEncoding=latin1", "root", "root");
            stmt = con.createStatement();

            stmt.executeUpdate("DROP DATABASE PROJECT;");
            stmt.executeUpdate("CREATE DATABASE PROJECT;");
            stmt.executeUpdate("USE PROJECT;");
            stmt.executeUpdate("CREATE TABLE USERS (USERNAME VARCHAR(20), PASSWORD VARCHAR(20));");
            stmt.executeUpdate("CREATE TABLE ITEMS (ITEMNAME VARCHAR(20), PRICE INTEGER);");
            stmt.executeUpdate("INSERT INTO ITEMS VALUES ('ITEM 1', 100);");
            stmt.executeUpdate("INSERT INTO ITEMS VALUES ('ITEM 2', 150);");
            stmt.executeUpdate("INSERT INTO ITEMS VALUES ('ITEM 3', 175);");
            stmt.executeUpdate("INSERT INTO ITEMS VALUES ('ITEM 4', 225);");
        } catch (Exception e) {
            e.printStackTrace();
        }
